...
function XCard({
    ...
    authorImage = "/images/profile.jpg", // Default placeholder
    content,
    isVerified = true,
    timestamp = "Now",
    reply,
    ...
    const CardContent = (
        <div
            className={cn(
                "w-full min-w-[300px] max-w-xl p-1.5 rounded-2xl relative isolate overflow-hidden",
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between items-start">
                            ...
                            <button
                                ...
                                className="h-8 w-8 text-black dark:text-white/80 hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5 rounded-lg p-1 flex items-center justify-center opacity-50"
                            >
                                <svg
